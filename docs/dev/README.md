...
- [docs/dev/architecture.md](architecture.md): system architecture and boundaries
- [docs/dev/design.md](design.md): product design principles
...
- [docs/dev/hpx-waveform-design.md](hpx-waveform-design.md): waveform and profile rationale
- [docs/dev/benchmark-harness.md](benchmark-harness.md): benchmark scenarios and regression gates
- [docs/dev/testbench-design.md](testbench-design.md): signal-path testbench design
...
- [docs/dev/pki-tooling-spec-map.md](pki-tooling-spec-map.md): PKI specification map and reading order
- [docs/dev/pki-tooling-requirements.md](pki-tooling-requirements.md): PKI requirements
- [docs/dev/pki-tooling-architecture.md](pki-tooling-architecture.md): PKI architecture
- [docs/dev/pki-tooling-data-model.md](pki-tooling-data-model.md): PKI data model
- [docs/dev/pki-tooling-api.md](pki-tooling-api.md): PKI API surface
- [docs/dev/pki-tooling-conformance.md](pki-tooling-conformance.md): PKI conformance and release gates
- [docs/dev/pki-tooling-trust-policy.md](pki-tooling-trust-policy.md): PKI moderation and trust policy
- [docs/dev/pki-tooling-operations-runbook.md](pki-tooling-operations-runbook.md): PKI operations runbook
- [docs/dev/pki-tooling-rollout-plan.md](pki-tooling-rollout-plan.md): PKI rollout milestones
- [docs/dev/pki-tooling-implementation-starter.md](pki-tooling-implementation-starter.md): PKI implementation starter blueprint
- [docs/dev/pki-tooling-glossary.md](pki-tooling-glossary.md): PKI glossary

## Research

- [docs/dev/vara-research.md](vara-research.md): VARA-related technical research notes
- [docs/dev/ardop-research.md](ardop-research.md): ARDOP research notes
- [docs/dev/pactor-research.md](pactor-research.md): PACTOR research notes
- [docs/dev/wsjtx-analysis.md](wsjtx-analysis.md): WSJT-X analysis notes
